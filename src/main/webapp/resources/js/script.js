...
var btn     = document.getElementById('sliderBtn'),
    ...
    // show sidebar 
    btn.addEventListener('click' , function(){    
        if (sideBar.classList.contains('max-md:-ml-64')) {
            sideBar.classList.replace('max-md:-ml-64' , 'max-md:ml-0');
            sideBar.classList.remove('max-md:slideOutLeft');
            sideBar.classList.add('max-md:slideInLeft');
        };
    });

    // hide sideBar    
    sideBarHideBtn.addEventListener('click' , function(){            
        if (sideBar.classList.contains('max-md:ml-0' , 'slideInLeft')) {      
            var _class = function(){
                sideBar.classList.remove('max-md:slideInLeft');
                sideBar.classList.add('max-md:slideOutLeft');
            ...
            var animate = async function(){
                ...
                setTimeout(function(){
                    sideBar.classList.replace('max-md:ml-0' , 'max-md:-ml-64');
                    console.log('animated');
                } , 300);                                                
